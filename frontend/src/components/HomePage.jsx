...
const HomePage = () => {
    return (
    <div className="col-lg-2 col-md-3 col-sm-6 mb-2 Card-Margin" style={{width: 'auto'}}>
        <Card style={{ width: '170px', border: 'none', marginTop: '60px' ,marginLeft:'auto', marginRight:'auto', display:'block'}}>
        <Card.Img className="Card-Image" style={{ width: '170px', height: '185px', borderRadius: '17px' }} variant="top" src="https://i.imgur.com/PU5Zex0.jpg"/>
