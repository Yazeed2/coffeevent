...
const Navigation = () => {
    return (
        <div >
            <Navbar href="/home" bg="light" expand="sm">
            <Navbar.Brand href="/home" style={{ fontSize: '24px', fontWeight: 'bolder'}} href="#"><img style={{marginRight:'10px'}} alt="" src="https://i.imgur.com/eFCHtTt.png" width="30" height="30"/>COFFEVENT</Navbar.Brand>
